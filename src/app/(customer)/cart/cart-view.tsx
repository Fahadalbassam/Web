...
export function CartView() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 md:py-14">
      <PageIntro title="Cart" description="Review quantities before checkout — your cart stays with this browser session." />
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_320px]">
        ...
        <aside className="h-fit rounded-xl border border-border bg-surface-2/50 p-6">
          ...
          {isLoggedIn ? (
            ...
            <Button type="button" className="mt-6 w-full" size="lg" onClick={() => openLogin("/checkout")}>
